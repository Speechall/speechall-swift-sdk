...
generate: ## Generate Swift code from OpenAPI spec
	...
	swift run swift-openapi-generator generate \
		...
		openapi.yaml \
		--output-directory Sources/SpeechallAPITypes/GeneratedSources
	swift run swift-openapi-generator generate \
		--config openapi-generator-config-client.yaml \
		openapi.yaml \
		--output-directory Sources/SpeechallAPI/GeneratedSources
	@echo "$(GREEN)Code generation complete!$(RESET)"

build: ## Build the Swift package
	@echo "$(YELLOW)Building SpeechallAPI...$(RESET)"
	swift build
